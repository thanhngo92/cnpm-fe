    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 sm:px-6">
      ...
      <div className="relative z-10 grid max-h-[90vh] w-full max-w-5xl overflow-hidden bg-white shadow-[0_30px_80px_rgba(15,23,42,0.18)] lg:grid-cols-[1.02fr_0.98fr]">
        <button
          ...
          aria-label="Đóng"
          onClick={onClose}
          className="absolute right-4 top-4 z-20 inline-flex h-10 w-10 items-center justify-center bg-white/95 text-slate-500"
        >
          <X className="h-4 w-4" />
        </button>
        ...
        <div className="overflow-y-auto px-5 py-6 sm:px-7 sm:py-7 lg:px-8 lg:py-8">
          ...
          <h2 className='mt-4 font-["Cormorant_Garamond",serif] text-3xl leading-[1.02] font-semibold text-slate-900 sm:text-[2.5rem]'>
            {product.name}
          </h2>
          ...
          <div className="mt-6 flex flex-col gap-4 py-5 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className='mt-2 font-["Cormorant_Garamond",serif] text-3xl font-semibold leading-none text-slate-950'>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <button
              ...
              onClick={onAddToCart}
              disabled={!inStock}
              className={`inline-flex h-11 flex-1 items-center justify-center gap-2 px-5 text-sm font-semibold transition-colors ${
                inStock
