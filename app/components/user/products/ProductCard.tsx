...
export default function ProductCard({
  ...
  return (
    <article
      ...
      className="group flex h-full cursor-pointer flex-col bg-white/0 shadow-none transition-all duration-300 hover:bg-white hover:shadow-[0_14px_30px_rgba(15,23,42,0.08)] focus:outline-none focus-visible:bg-white focus-visible:shadow-[0_14px_30px_rgba(15,23,42,0.08)]"
    >
      ...
      <div className="flex flex-1 flex-col px-4 pt-3 pb-4">
        <p className='font-["Inter",sans-serif] text-[11px] font-semibold uppercase tracking-[0.22em] text-[#94A3B8]'>
          {product.brand}
        </p>

        <h3 className='mt-1 line-clamp-2 min-h-[3rem] font-["Cormorant_Garamond",serif] text-[20px] leading-[1.08] font-medium text-slate-900 sm:text-[22px]'>
          {product.name}
        </h3>

        <p className='mt-1.5 line-clamp-2 min-h-[2.4rem] font-["Cormorant_Garamond",serif] text-[15px] leading-[1.24] font-normal text-slate-600'>
          {product.description}
        </p>
